  ...
  return (
    <div className='container'>
      ...
      <p>
        ...
        of Alps Inc's Website, located at www.alps.com.
      </p>
      <br></br>
      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Alps if you do not agree to take all
      ...
      <p>
        We employ the use of cookies. By accessing Alps, you agreed to use
        cookies in agreement with the Alps Inc's Privacy Policy.{' '}
      </p>
      <br></br>
      <p>
      ...
      <p>
        Unless otherwise stated, Alps Inc and/or its licensors own the
        intellectual property rights for all material on Alps. All intellectual
        property rights are reserved. You may access this from Alps for your own
      ...
      <ul>
        <li>
          <p>Republish material from Alps</p>
        </li>
        <li>
          <p>Sell, rent or sub-license material from Alps</p>
        </li>
        <li>
          <p>Reproduce, duplicate or copy material from Alps</p>
        </li>
        <li>
          <p>Redistribute content from Alps</p>
        </li>
      </ul>
      <br></br>
      <p>
        Parts of this website offer an opportunity for users to post and
        exchange opinions and information in certain areas of the website. Alps
        Inc does not filter, edit, publish or review Comments prior to their
        presence on the website. Comments do not reflect the views and opinions
        of Alps Inc,its agents and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent
        permitted by applicable laws, Alps Inc shall not be liable for the
      ...
      <br></br>
      <p>
        Alps Inc reserves the right to monitor all Comments and to remove any
      ...
      <br></br>
      <p>
        You hereby grant Alps Inc a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Alps Inc; and (d) the link is
      ...
      <p>
        ...
        e-mail to Alps Inc. Please include your name, your organization name,
      ...
      <br></br>
      <p>
        No use of Alps Inc's logo or other artwork will be allowed for linking
